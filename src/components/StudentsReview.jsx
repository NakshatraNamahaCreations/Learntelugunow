          ...
          <div className="col right-col">
            <div className="single-testimonial-content">
              <div className="content-text">
                <p>
                  <span className="highlight-brand">Learn Telugu Now</span> offers expert-led Telugu language courses for all skill levels. Master Telugu at your own pace with our comprehensive online platform featuring interactive lessons, flexible schedules, and personalized learning paths designed to help you succeed.
                </p>
              </div>
            </div>
          </div>
